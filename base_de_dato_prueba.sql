...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `salvadora` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `compra` (
  ...
  `COD_PRODUCTO` int NOT NULL DEFAULT '0',
...
-- Dump completed on 2024-10-11 11:09:39
